...
class MyOpenGLWidgegt: public QOpenGLWidget, public QOpenGLFunctions

{
   Q_OBJECT
public:
   MyOpenGLWidgegt(s21::Controller * controller_,QWidget *parent = nullptr);
   ...
   void setFigureColor( float chosen_red, float chosen_green, float chosen_blue);
     void setPointColor( float chosen_red_point, float chosen_green_point, float chosen_blue_point);
     void setBackgroundColor( float chosen_red_background, float chosen_green_background, float chosen_blue_background , float chosen_alpha_background);
