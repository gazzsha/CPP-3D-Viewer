#ifndef S21_CPP4_3DVIEWER_V2_SRC_MODEL_MODEL_H
#define S21_CPP4_3DVIEWER_V2_SRC_MODEL_MODEL_H
...
class Model {
 ...
 public:
  ...
  void SetMinMaxData();
  void ClearData() {
    max_min_values.x_max_min.clear();
    max_min_values.y_max_min.clear();
    max_min_values.z_max_min.clear();
